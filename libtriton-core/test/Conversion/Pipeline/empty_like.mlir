...
// TorchExt globals + dispatcher (generated by rewrite-torch-as-torchext):
...
// CHECK:         %[[UNPACK_SLOT:.*]] = llvm.alloca %[[C1]] x !llvm.ptr
// CHECK:         llvm.call @mLibTritonTVMFFIObjectToTensor(%[[ARG0]], %[[UNPACK_SLOT]])
// CHECK:         %[[ATEN_HANDLE:.*]] = llvm.load %[[UNPACK_SLOT]] : !llvm.ptr -> !llvm.ptr
// Store the input tensor pointer at slot[0].
// CHECK:         %[[PTRINT:.*]] = llvm.ptrtoint %[[ATEN_HANDLE]] : !llvm.ptr to i64
...
// CHECK:         %[[PACK2_SLOT:.*]] = llvm.alloca %[[C1]] x !llvm.ptr
// CHECK:         llvm.call @mLibTritonTensorToTVMFFIObject(%[[RES_PTR]], %[[PACK2_SLOT]])
// CHECK:         %[[RET_HANDLE:.*]] = llvm.load %[[PACK2_SLOT]] : !llvm.ptr -> !llvm.ptr
// CHECK-NEXT:    llvm.return %[[RET_HANDLE]] : !llvm.ptr
